...
public class RegionListAdapter extends BaseAdapter {
	...
	public RegionListAdapter(Context context, List<RegionManEntity> list) {
	...
	public void setList(List<RegionManEntity> list) {
		this.list = list;
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		RegionManEntity entity = list.get(position);
