...
public class ChinaCityUtil {
	...
	public final static Hashtable<String, String[]> TmpCity;
	
	static {
		TmpCity = new Hashtable<String, String[]>();
		initChinaCitysHashtable();
	}

	public static void initChinaCitysHashtable() {
		// 从小地区开始构建
		// 北京市
		TmpCity.put("北京市", new String[] { "昌平区", "朝阳区", "崇文区", "大兴区", "东城区",
				"房山区", "丰台区", "海淀区", "怀柔区", "门头沟", "密云区", "平谷区", "石景山区", "顺义区",
				"通州区", "西城区", "宣武区", "延庆县" });
...
//		tmpProvince.put("安徽省", TmpCity);
		// 重庆市
//		TmpCity = new Hashtable<String, String[]>();
		TmpCity.put("重庆市", new String[] { "巴南区", "北碚区", "璧山县", "长寿县", "大渡口区",
				"大足县", "垫江县", "涪陵区", "合川区", "江北区", "江津区", "九龙坡区", "南岸区", "南川区",
				"綦江县", "黔江区", "荣昌县", "沙坪坝区", "铜梁县", "万州区", "永川区", "渝北区", "渝中区",
				"云阳县", "忠县" });
//		tmpProvince.put("重庆市", TmpCity);
		// 福建省
//		TmpCity = new Hashtable<String, String[]>();
		TmpCity.put("福州市", new String[] { "仓山区", "长乐市", "福清市", "鼓楼区", "晋安区",
				"连江县", "马尾区", "闽侯县", "台江区" });
		TmpCity.put("龙岩市", new String[] { "新罗区" });
		TmpCity.put("南平市", new String[] { "光泽县", "建瓯市", "建阳市", "邵武市", "顺昌县",
				"松溪县", "武夷山市", "延平区", "政和县" });
		TmpCity.put("宁德市", new String[] { "福安市", "福鼎市", "蕉城区", "屏南县", "寿宁县",
				"柘荣县", "周宁县" });
		TmpCity.put("莆田市", new String[] { "城厢区", "涵江区", "荔城区" });
		TmpCity.put("泉州市", new String[] { "安溪县", "德化县", "丰泽区", "惠安县", "晋江市",
				"鲤城区", "洛江区", "南安市", "石狮市", "永春县" });
		TmpCity.put("三明市", new String[] { "梅列区", "三元区" });
		TmpCity.put("厦门市", new String[] { "海沧区", "湖里区", "集美区", "思明区", "同安区",
				"翔安区" });
...
//		TmpCity = new Hashtable<String, String[]>();
		...
		TmpCity.put("广州市", new String[] { "白云区", "从化市", "番禺区", "海珠区", "花都区",
				"黄浦区", "南沙区", "萝岗区", "荔湾区", "天河区", "越秀区", "增城市" });
		...
		TmpCity.put("韶关市", new String[] { "浈江区", "乐昌市", "南雄市", "仁化县",
				"乳源瑶族自治县", "始兴县", "武江区", "浈江区曲江区 " });
		TmpCity.put("深圳市", new String[] { "宝安区", "福田区", "龙岗区", "罗湖区", "南山区",
				"盐田区" });
...
//		tmpProvince.put("广东省", TmpCity);
		// 广西壮族自治区
//		TmpCity = new Hashtable<String, String[]>();
		TmpCity.put("百色市", new String[] { "凌云县", "平果县", "田东县", "田阳县", "右江区",
				"靖西县" });
		...
		TmpCity.put("南宁市", new String[] { "西乡塘区", "江南区", "青秀区", "兴宁区",
				"良庆区 武鸣县", "横县", "宾阳县" });
...
//		TmpCity = new Hashtable<String, String[]>();
		...
		TmpCity.put("贵阳市", new String[] { "白云区", "花溪区", "南明区", "乌当区", "小河区",
				"云岩区" });
...
//		tmpProvince.put("海南省", TmpCity);
		// 河北省
//		TmpCity = new Hashtable<String, String[]>();
		TmpCity.put("保定市", new String[] { "北市区", "定兴县", "定州市", "高碑店市", "南市区",
				"清苑县", "新市区", "涿州市" });
		...
		TmpCity.put("廊坊市", new String[] { "安次区", "霸州市", "固安市", "广阳区", "三河市",
				"香河县" });
		TmpCity.put("秦皇岛市", new String[] { "北戴河区", "昌黎县", "抚宁县", "海港区" });
		TmpCity.put("石家庄市", new String[] { "长安区", "藁城市", "鹿泉市", "桥东市", "桥西区",
				"新华区", "裕华区", "正定县" });
		TmpCity.put("唐山市", new String[] { "丰南区", "丰润区", "古治区", "开平区", "路北区",
				"路南区", "滦县", "唐海县" });
...
//		TmpCity = new Hashtable<String, String[]>();
		...
		TmpCity.put("开封市",
				new String[] { "鼓楼区", "金明区", "龙亭区", "顺河回族区", "禹王台区" });
		TmpCity.put("洛阳市", new String[] { "瀍河回族区", "吉利区", "涧西区", "老城区", "洛龙区",
				"西工区" });
...
//		TmpCity = new Hashtable<String, String[]>();
		...
		TmpCity.put("哈尔滨市", new String[] { "道里区", "道外区", "南岗区", "平房区", "香坊区",
				"松北区" });
...
//		TmpCity = new Hashtable<String, String[]>();
		...
		TmpCity.put("武汉市", new String[] { "东西湖区", "汉阳区", "洪山区", "江岸区", "江汉区",
				"江夏区", "硚口区", "青山区", "武昌区", "新洲区" });
...
//		tmpProvince.put("湖北省", TmpCity);
		// 湖南省
//		TmpCity = new Hashtable<String, String[]>();
		TmpCity.put("长沙市", new String[] { "长沙县", "芙蓉区", "开福区", "天心区", "雨花区",
				"岳麓区" });
...
//		tmpProvince.put("吉林省", TmpCity);
		// 江苏省
//		TmpCity = new Hashtable<String, String[]>();
		TmpCity.put("常州市", new String[] { "金坛市", "溧阳市", "戚墅堰区", "天宁区", "武进区",
				"新北区", "钟楼区" });
		TmpCity.put("淮安市", new String[] { "楚州区", "淮阴区", "金湖县", "涟水县", "清河区",
				"青浦区", "盱眙县" });
		TmpCity.put("连云港市", new String[] { "东海县", "赣榆县", "灌南县", "灌云县", "海州区",
				"连云区", "新浦区" });
		TmpCity.put("南京市", new String[] { "白下区", "鼓楼区", "建邺区", "江宁区", "六合区",
				"浦口区", "栖霞区", "秦淮区", "玄武区", "雨花台区", "下关区" });
		TmpCity.put("南通市", new String[] { "崇川区", "港闸区", "海安县", "海门市", "启东市",
				"如东县", "如皋市", "通州市" });
		TmpCity.put("苏州市", new String[] { "沧浪区", "常熟市", "虎丘区", "金阊区", "昆山市",
				"平江区", "太仓市", "吴江市", "吴中区", "相城区", "张家港市" });
		TmpCity.put("宿迁市", new String[] { "宿城区", "宿豫区" });
		TmpCity.put("泰州市", new String[] { "海陵区", "姜堰市", "兴化市", "高港区", "靖江市" });
		TmpCity.put("无锡市", new String[] { "北塘区", "滨湖区", "崇安区", "惠山区", "江阴市",
				"南长区", "锡山区", "宜兴区" });
		TmpCity.put("徐州市", new String[] { "丰县", "鼓楼区", "九里区", "邳州市", "泉山区",
				"新沂市", "云龙区", "铜山县" });
		TmpCity.put("盐城市", new String[] { "滨海县", "大丰市", "东台市", "建湖县", "亭湖区",
				"盐都县", "盐都新区" });
		TmpCity.put("扬州市", new String[] { "宝应县", "高邮市", "广陵区", "邗江区", "江都市",
				"维扬区", "仪征区" });
		TmpCity.put("镇江市", new String[] { "丹徒区", "丹阳市", "京口区", "句容市", "润州区",
				"扬中市" });
//		tmpProvince.put("江苏省", TmpCity);
		// 江西省
//		TmpCity = new Hashtable<String, String[]>();
		...
		TmpCity.put("南昌市", new String[] { "东湖区", "南昌县", "青山湖区", "青云谱区", "湾里区",
				"西湖区", "新建县" });
...
//		tmpProvince.put("江西省", TmpCity);
		// 辽宁省
//		TmpCity = new Hashtable<String, String[]>();
		TmpCity.put("鞍山市", new String[] { "海城市", "立山区", "千山区", "台安县", "铁东区",
				"铁西区", "岫岩满族自治县" });
		TmpCity.put("本溪市", new String[] { "本溪满族自治县", "桓仁满族自治县", "明山区", "平山区",
				"溪湖区" });
		TmpCity.put("朝阳市", new String[] { "北票市", "朝阳县", "建平县", "喀喇沁左翼蒙古族自治县",
				"凌源市", "龙城区", "双塔区" });
		TmpCity.put("大连市", new String[] { "甘井子区", "金州区", "旅顺口区", "普兰店市",
				"沙河口区", "瓦房店市", "西岗区", "中山区", "庄河市" });
		TmpCity.put("丹东市", new String[] { "东港市", "凤城市", "宽甸满族自治县", "元宝区",
				"振安区", "振兴区" });
		TmpCity.put("抚顺市", new String[] { "抚顺县", "顺城区", "望花区", "新抚区" });
		TmpCity.put("阜新市", new String[] { "阜新蒙古族自治县", "海州区", "清河门区", "太平区",
				"细河区", "新邱区", "彰武区" });
		TmpCity.put("葫芦岛市", new String[] { "建昌县", "连山区", "龙港区", "绥中县", "兴城市" });
		TmpCity.put("锦州市", new String[] { "古塔区", "黑山县", "凌海市", "凌河区", "太和区",
				"义县    " });
		TmpCity.put("辽阳市", new String[] { "白塔区", "灯塔市", "弓长岭区", "宏伟区", "辽阳县",
				"太子河区", "文圣区" });
		TmpCity.put("盘锦市", new String[] { "大洼县", "盘山县", "双台子区", "兴隆台区" });
		TmpCity.put("沈阳市", new String[] { "大东区", "东陵区", "法库县", "和平区", "皇姑区",
				"康平县", "辽中县", "沈河区", "苏家屯区", "铁西区", "沈北新区", "新民市", "于洪区",
				"浑南新区" });
		TmpCity.put("铁岭市", new String[] { "昌图县", "调兵山市", "开原市", "清河区", "铁岭县",
				"银州区" });
		TmpCity.put("营口市", new String[] { "鲅鱼圈区", "大石桥市", "盖州市", "西市区", "站前区",
				"老边区" });
...
//		TmpCity = new Hashtable<String, String[]>();
		...
		TmpCity.put("济南市", new String[] { "长清区", "槐荫区", "历城区", "历下区", "平阴县",
				"市中区", "天桥区", "章丘市" });
		TmpCity.put("济宁市", new String[] { "金乡县", "梁山县", "曲阜市", "市中区", "泗水县",
				"任城区" });
		TmpCity.put("莱芜市", new String[] { "钢城区", "莱城区" });
		TmpCity.put("聊城市", new String[] { "东阿县", "东昌府区", "临清市", "阳谷县" });
		TmpCity.put("临沂市", new String[] { "河东区", "兰山区", "罗庄区", "沂水县" });
		TmpCity.put("青岛市", new String[] { "城阳区", "黄岛区", "即墨市", "胶南市", "胶州市",
				"莱西市", "崂山区", "李沧区", "平度市", "市北区", "市南区", "四方区" });
		TmpCity.put("日照市", new String[] { "东港区", "莒县", "五莲县" });
		TmpCity.put("泰安市", new String[] { "岱岳区", "泰山区", "新泰市" });
		TmpCity.put("威海市", new String[] { "环翠区", "乳山市", "文登市" });
		TmpCity.put("潍坊市", new String[] { "昌乐县", "昌邑市", "坊子区", "高密市", "寒亭区",
				"奎文区", "青州市", "潍城区", "寿光市", "诸城市" });
		TmpCity.put("烟台市", new String[] { "福山区", "海阳市", "莱山区", "莱阳市", "莱州市",
				"龙口市", "牟平区", "蓬莱市", "栖霞市", "招远市", "芝罘区", "开发区" });
		TmpCity.put("枣庄市", new String[] { "市中区", "滕州市", "山亭区", "薛城区", "峄城区" });
		TmpCity.put("淄博市", new String[] { "博山区", "临淄区", "沂源县", "张店区", "周村区",
				"淄川区" });
...
//		TmpCity = new Hashtable<String, String[]>();
		...
		TmpCity.put("太原市", new String[] { "古交市", "尖草坪区", "晋源区", "万柏林区", "小店区",
				"杏花岭区", "迎泽区" });
...
//		TmpCity = new Hashtable<String, String[]>();
		...
		TmpCity.put("西安市", new String[] { "灞桥区", "碑林区", "长安区", "莲湖区", "临潼区",
				"未央区", "新城区", "阎良区", "雁塔区", "西高经济技术产业开发区" });
...
//		tmpProvince.put("陕西省", TmpCity);
		// 上海市
//		TmpCity = new Hashtable<String, String[]>();
		TmpCity.put("上海市", new String[] { "宝山区", "长宁区", "崇明县", "奉贤区", "虹口区",
				"黄浦区", "嘉定区", "金山区", "静安区", "卢湾区", "闵行区", "南汇区", "浦东新区", "普陀区",
				"青浦区", "松江区", "徐汇区", "杨浦区", "闸北区" });
//		tmpProvince.put("上海市", TmpCity);
		// 四川省
//		TmpCity = new Hashtable<String, String[]>();
		TmpCity.put("巴中市", new String[] { "巴州区" });
		TmpCity.put("成都市", new String[] { "成华区", "金牛区", "锦江区", "龙泉驿区", "青白江区",
				"青羊区", "双流县", "温江区", "武侯区", "新都区", "郫县" });
...
//		tmpProvince.put("四川省", TmpCity);
		// 天津市
//		TmpCity = new Hashtable<String, String[]>();
		TmpCity.put("天津市", new String[] { "宝坻区", "北辰区", "大港区", "东丽区", "汉沽区",
				"和平区", "河北区", "河东区", "河西区", "红桥区", "蓟县", "津南区", "静海县", "南开区",
				"宁河县", "塘沽区", "武清区", "西青区" });
...
//		tmpProvince.put("云南省", TmpCity);
		// 浙江省
//		TmpCity = new Hashtable<String, String[]>();
		TmpCity.put("杭州市", new String[] { "滨江区，淳安县", "富阳市", "拱墅区", "建德市",
				"江干区", "临安市", "上城区", "桐庐县", "西湖区", "下城区", "萧山区", "余杭区" });
		TmpCity.put("湖州市", new String[] { "长兴县", "德清县", "南浔区", "吴兴区" });
		TmpCity.put("嘉兴市", new String[] { "海宁市", "海盐县", "平湖市", "桐乡市", "南湖区",
				"秀洲区" });
		TmpCity.put("金华市", new String[] { "东阳市", "金东区", "兰溪市", "浦江县", "武义县",
				"婺城区", "义乌市", "永康市" });
		TmpCity.put("丽水市", new String[] { "缙云县", "莲都区", "龙泉市", "青田县", "松阳县",
				"遂昌县", "云和县" });
		TmpCity.put("宁波市", new String[] { "北仑区", "慈溪市", "奉化市", "海曙区", "江北区",
				"江东区", "宁海县", "象山县", "鄞州区", "余姚市", "镇海区" });
		TmpCity.put("衢州市", new String[] { "常山县", "江山市", "开化县", "柯城区", "龙游县",
				"衢江区" });
		TmpCity.put("绍兴市", new String[] { "上虞市", "绍兴县", "嵊州市", "新昌县", "越城区",
				"诸暨市" });
		TmpCity.put("台州市", new String[] { "黄岩区", "椒江区", "临海市", "路桥区", "三门县",
				"天台县", "温岭市", "仙居县", "玉环县" });
		TmpCity.put("温州市", new String[] { "苍南县", "乐清市", "龙湾区", "鹿城区", "瓯海区",
				"平阳区", "瑞安市", "永嘉市" });
...
//		TmpCity = new Hashtable<String, String[]>();
		...
		TmpCity.put("乌鲁木齐市", new String[] { "米泉\\石化", "沙依巴克区", "水磨沟区", "天山区",
				"新市区", "经济开发区" });
...
//		tmpProvince.put("新疆维吾尔自治区", TmpCity);
	 ...
	 *            指定的地区参数。
	 * */
	public static String[] findAreaStringArr(int type,
			String args) {
		String[] arr = null;
		if (TmpCity == null) {
			initChinaCitysHashtable();
...
//		String[] strings = findAreaStringArr(TmpCity, TYPE_REGION, "武汉市");
//		for (String string : strings) {
//			System.out.print(string + " ");
//		}
//	}

	public static String[] getKeyArrayByTable(
			Hashtable<String, ? extends Object> table) {
		String[] arr = null;
